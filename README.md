...
![Images/landingResize.png](Instructions/Images/landingResize.png)
...
* You may use the [weather data](Instructions/Resources/cities.csv) or choose another dataset. Alternatively, you may use the included [cities dataset](Instructions/Resources/cities.csv) and pull the images from the [assets folder](Instructions/Resources/assets).
